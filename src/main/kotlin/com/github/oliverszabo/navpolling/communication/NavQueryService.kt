...
class NavQueryService(
    ...
    fun fetchInvoiceDigests(
        ...
        do {
            ...
            currentBoundFrom = currentBoundTo.plusSeconds(1)
    ...
    private fun createNavClient() : NavClient {
    ...
    private suspend fun fetchInvoiceData(
        ...
        return client.query(
            ...
            QueryInvoiceDataRequest(
                ...
                if(invoiceDirection == InvoiceDirection.INBOUND) invoiceDigest.supplierTaxNumber else null
            ),
